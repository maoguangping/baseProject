...
public class TokenUtil {
     ...
     */
    static {
        InputStream inputStream = TokenUtil.class.getClassLoader().getResourceAsStream("InfoConfig.properties");
        ...
        GRANT_TYPE = prop.getProperty("easemob.grant.type");
        CLIENT_ID = prop.getProperty("easemob.client.id");
        CLIENT_SECRET = prop.getProperty("easemob.client.secret");
